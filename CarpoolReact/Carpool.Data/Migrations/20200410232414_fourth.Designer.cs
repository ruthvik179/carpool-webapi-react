...
namespace Carpool.Migrations
{
    ...
    [Migration("20200410232414_fourth")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarpoolReact.Models.RideRequest", b =>
                {
                    b.HasOne("CarpoolReact.Models.Location", "BoardingPoint")
                        .WithMany()
                        .HasForeignKey("BoardingPointId");

                    b.HasOne("CarpoolReact.Models.Location", "DropoffPoint")
                        .WithMany()
            ...
            modelBuilder.Entity("CarpoolReact.Models.Route", b =>
                {
                    b.HasOne("CarpoolReact.Models.Location", "Destination")
                        .WithMany()
                        .HasForeignKey("DestinationId");

                    b.HasOne("CarpoolReact.Models.Location", "Source")
                        .WithMany()
